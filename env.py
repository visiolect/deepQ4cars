...
# Getting our AI, which we call "agent", and that contains our neural network that represents our Q-function
agent = DeepQ(5, 3, 0.9)
...
class Game(Widget):
    ...
    def update(self, dt):
        ...
        action = agent.update(last_reward, last_signal)
...
class CarApp(App):
    ...
    def load(self, obj):
        print("loading last saved agent...")
        agent.load()
